...
- Excel-ის ორმაგი რენდერი: ავტორის print layout და უსაფრთხო, წაკითხვადობაზე მორგებული AutoFit ხედი;
...
ნაგულისხმევი `Both` რეჟიმი ორივე ხედს ქმნის. სიზუსტისთვის მთავარი არის `workbook-layout` და ორიგინალი Excel. `auto-layout` მხოლოდ წაკითხვის გასამარტივებელი ხედია: ფართო ცხრილს ძალით ერთ გვერდში აღარ კუმშავს და დაახლოებით ყოველ რვა შევსებულ სვეტს ცალკე ჰორიზონტალურ გვერდზე ანაწილებს; სიმაღლე შეუზღუდავია. AutoFit ნაგულისხმევად არ გამოიყენება დამალულ/ცარიელ ფურცელზე, 60 სვეტზე ფართო შევსებულ დიაპაზონზე, manual page break-ის ან chart/image/drawing object-ის არსებობისას. გაერთიანებული უჯრედები ვიზუალური გადამოწმების გაფრთხილებას ქმნის. წყარო read-only იხსნება და არასოდეს ინახება.
